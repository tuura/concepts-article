...
\noun{Workcraft}~\cite{2007_poliakov_workcraft}[Z], and others.
...
Concepts can be automatically translated into equivalent STGs that can
be formally verified using standard tools, e.g.~\cite{2007_poliakov_workcraft}[W].
After all scenarios have been translated to STGs and verified, they can be
...
TODO for Andrey: list of contributions with forward references to specific sections.
