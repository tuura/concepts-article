...
$\,\mathsf{initialise}\,b \,False$ and $\,\mathsf{initialise}\,c \,False$. These state that the initial states of all three signals is 0, and therefore we have to add a single token to places $a_0$,
...
\begin{flushleft}
$\,\mathsf{initialState}=\mathsf{initialise} \, uv \, False\,\diamond\,\mathsf{initialise}\,oc\,False$~
\par\end{flushleft}
