...
we focus on developing a flexible textual specification language that can be
used by a circuit designer directly, without the need to explicitly describe
systems by large graph-based models.
...
Several of the abovementioned approaches feature similar ideas which make them beneficial in certain ways,
