...
\begin{centering}
\protect\caption{\label{fig:step-by-step1}The first step in converting concepts to an STG \textbf{REPLACES THESE WITH DIAMONDS}}
...
All concepts like this can be added to the STG in the same way. The STG following insertion of all concepts in the above list, before the \emph{initiliase} concepts, will produce an STG as shown in~\ref{fig:step-by-step9}

\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.225]{Images/Step-by-step9}
\par\end{centering}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.225]{Images/Step-by-step12}
\par\end{centering}
...
\subsection{Parrallel and scenario composition}

With this method of converting STGs to 
