...
The example we will use in the case study of this article is that of a simple buck converter. 
A detailed description of this can be found in Section~\ref{sec:case-study}, but for this section it
serves as an example of how the monolithic design approach is carried out. 
Figure~\ref{fig:Monolithic-buck} contains the final STG for a simple buck converter, and we will discuss how 
...
\begin{figure}[t]
\begin{centering}
\includegraphics[scale=0.74]{Images/c-element-circuit-redo}
...
\begin{centering}
\protect\caption{\label{fig:sequential_combination}An example of concurrent combination}
...
\begin{centering}
\protect\caption{\label{fig:sequential_combination}An example of non-deterministic combination}
...
We also include an \textsf{interface} concepts in order to include the
