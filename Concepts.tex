...
With the information provided here, a designer can then work to produce a formal specification using the monolithic approach.
Figure~\ref{fig:Monolithic-buck} contains a completed STG specification for a simple buck controller.
